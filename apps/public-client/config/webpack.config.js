...
module.exports = function (webpackEnv) {
  ...
  const getStyleLoaders = (cssOptions, preProcessor, useStringLoader) => {
    const loaders = [
      isEnvDevelopment && !useStringLoader && require.resolve('style-loader'),
      isEnvProduction && {
  ...
  return {
    ...
    output: {
      // The build folder.
      path: isEnvProduction ? paths.appBuildClient : undefined,
    ...
    plugins: [
      ...
      // See https://github.com/facebook/create-react-app/ispaths.brickSharedSrc,sues/240
      ...
      isEnvProduction &&
        new HTMLInlineCSSWebpackPlugin({
          replace: {
            removeTarget: true,
            target: 'HTMLInlineCSSWebpackPlugin_injection_point',
          },
        }),
